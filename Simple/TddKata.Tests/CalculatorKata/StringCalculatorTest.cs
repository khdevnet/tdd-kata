...
namespace TddKata.Tests.CalculatorKata
{
    ...
    public class StringCalculatorTest
    {
        ...
        {
            int result = CreateStringCalculator().Add(number);
        ...
        public void AddReturnSumByIgnoringMoreThanThousandWhenSuppliedMultipleNumbersInString(string numbers,
            int expectedResult)
        {
            int result = CreateStringCalculator().Add(numbers);
            Assert.That(result, Is.EqualTo(expectedResult));
        }
        ...
        {
            Exception exception = Assert.Throws<ArgumentException>(() => CreateStringCalculator().Add(numbers));
        ...
        {
            int result = CreateStringCalculator().Add(input);

            Assert.That(result, Is.EqualTo(expectation));
        }

        private static StringCalculator CreateStringCalculator() => new StringCalculator();
    }
}